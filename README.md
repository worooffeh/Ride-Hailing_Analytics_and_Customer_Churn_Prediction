...
```
ridewise/
├── RideWise_Workplan.docx        # the primary deliverable — challenge→solution→method
├── README.md
├── requirements.txt
├── src/
│   ├── ridewise_pipeline.py      # shared data-prep + feature-engineering module
│   └── app.py                    # FastAPI scoring service (generated by NB08)
